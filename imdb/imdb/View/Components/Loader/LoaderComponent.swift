...
struct LoaderComponent: View {
    ...
    var body: some View {
        if isVisible {
            VStack {
                Spinner()
                Text("Cargando todos los pokemons...")
                    .padding(.top, 20)
            }
            .padding()
            .cornerRadius(4)
    ...
    var body: some View {
        ZStack {
            ...
            ZStack {
                ...
                // S2
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS2, color: Color("FireColor"))

                // S1
                SpinnerCircle(start: spinnerStart, end: spinnerEndS1, rotation: rotationDegreeS1, color: Color("FightingColor"))
